...
bool write_xbar(uint8_t port) {
  ...
  buffer[4] =  0b10101011 ; // port 4 = output , no internal termination , not inverted , filler.       From port 10. PLL input , FMC1_CLK2_BIDIR. Connected to 250MHz from backplane
